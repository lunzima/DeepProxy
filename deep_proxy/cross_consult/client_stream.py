...
async def stream_cross_consult_continuation(
    *,
    ...
    追加的 cc tool_call assistant 消息缺 reasoning_content 时，由 _assemble_litellm_body
    的 reasoning 安全网在上游装配期统一 dummy 兜底（thinking 模式不 400）。
    ...
    for _turn in range(max_turns):
        ...
        # reasoning_content 缺失由 _assemble_litellm_body 安全网在装配期 dummy 兜底。
